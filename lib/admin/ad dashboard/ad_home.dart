...
import 'package:soupboys/admin/ad%20dashboard/ad%20home/order_summary_ad.dart';
...
class AdHome extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildoredersummaryTitle(),
            const OrderSummaryAd(),
            const SizedBox(height: 20),
            _buildDivider(),
  ...
  Widget _buildDashboardTitle() {
   ...
   Widget _buildoredersTitle() {
    return const Text(
      'Orders',
      style: titleStyle,
    );
  }
    Widget _buildoredersummaryTitle() {
    return const Text(
      'Order Summary',
      style: titleStyle,
    );
