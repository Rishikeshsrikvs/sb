...
class UsUrorder extends StatelessWidget {
  const UsUrorder({Key? key}) : super(key: key);
                ...
                if (paymentIncomplete) ...[
                  ...
                  const Row(
                    children: [
                      ...
                      SizedBox(width: 4),
                      Text('Payment Incomplete', style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ],
              ],
